...
?>
    ...
    <div class="row">
        <div class="col-lg-3">
            ...
            ?>
                <img src="<?php echo($foto_mostrar['nombre'])?>">
        ...
        <div class="col-lg-3">
            ...
            <h1>Apariencia</h1>
            <h3>Altura</h3>
            <?php echo utf8_encode($datos_usuario[altura]);  ?>cm.
            <br>
            <h3>Complexión</h3>
            <?php echo utf8_encode($datos_usuario[complexion]);?>
            <br>
            <h3>Color de ojos</h3>
            <?php echo utf8_encode($datos_usuario[color_ojos]);?>
            <br>
            <h3>Pelo</h3>
            <?php echo utf8_encode($datos_usuario[color_pelo]);?>, 
            <?php echo utf8_encode($datos_usuario[tipo_pelo]);?>
            </div>
            </div>
        <div class="col-lg-6">
            <div class="desc">
